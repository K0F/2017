...
String txt[] = {
  "",
  "procesy probíhající v reálném čase",
  "stroj jako nástroj",
  "člověk jako měřítko",
  "problematika instrukcí",
  "múzické působení algoritmů",
  "Vilém Flusser",
  "Steina a Woody Vasulka",
  "svodoný software",
  "GNU / Linux",
  "Richard Stallman",
  "svobodná kultura",
  ...
  "Supercollider",
  "bourne shell",
  "jakýkoli nástroj, kterým se dokážete vyjadřovat"
};
...
void draw(){
  ...
  b = (sin(magicnum/100768.3)+1.0)/2.0*256.0;
